...
#                                                                             
# PROGRAMMER: Damilola Olaide Banjoko
...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        result = images_dir + key
        model_label = classifier(result, model)
       ...
       #           for the key indicated by the variable key - too winded* what does this even mean?
       #
       ...
       # results_dic as an exact match(1) using extend list function
        if truth in model_label:
            ...
            #where there is a match add 1, 
            #print('exists')
            #results_dic[key].extend(model_label)
            #results_dic[truth][2] == 1     #resolve this bug* 
            #check =   results_dic[key].extend(model_label, 1)
            results_dic[key].append(model_label) #this used to be model label
            ...
            #print('no luck here')  #eck this out again
