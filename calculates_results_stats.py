...
# REVISED DATE:  severally until 10/04/2021
...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1:
            if results_dic[key][2] == 1:
                #print('step 1')
                results_stats_dic['n_correct_breed'] =  results_stats_dic['n_correct_breed']  + 1  #crosscheck
    ...
    results_stats_dic['pct_match'] = (results_stats_dic['n_match'] / results_stats_dic['n_images'] ) * 100 #corrected n_dogs_img to n_match
